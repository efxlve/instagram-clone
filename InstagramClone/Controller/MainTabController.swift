...
class MainTabController: UITabBarController {
    ...
    func configureViewControllers(withUser user: User) {
        ...
        let imageSelector = templateNavigationController(unselectedImage: #imageLiteral(resourceName: "plus_unselected"), selectedImage: #imageLiteral(resourceName: "plus_unselected"), rootViewController: FeedController(collectionViewLayout: layout))
